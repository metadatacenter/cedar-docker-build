...
export IMAGE_VERSION=2.9.15-SNAPSHOT
export CEDAR_MAVEN_VERSION=2.9.15-SNAPSHOT
...
export CEDAR_APPLICATION_VERSION=2.9.15-SNAPSHOT
...
export CEDAR_TEMPLATE_EDITOR_NPM_VERSION=2.9.14-dev.20260914.gaf984eef198c.t0328.p4
export CEDAR_WORKSPACE_NPM_VERSION=2.9.14-dev.20260914.gb947519a4a08.t0328.p4
export CEDAR_TEMPLATE_DESIGNER_NPM_VERSION=2.9.14-dev.20260913.g9523f415551c.t161319.p3
export CEDAR_OPENVIEW_NPM_VERSION=2.9.14-dev.20260914.g8a037d574371.t0328.p4
export CEDAR_OPENVIEW_CEE_NPM_VERSION=2.0.12-dev.20260914.g96b2097b644b.t0328
export CEDAR_OPENVIEW_WEBCOMPONENTS_NPM_VERSION=2.8.0
export CEDAR_CONTENT_NPM_VERSION=2.9.14-dev.20260913.g4ac9c082d5e5.t151009.p3
export CEDAR_MONITORING_NPM_VERSION=2.9.14-dev.20260913.g132a87e5fd30.t151007.p3
export CEDAR_BRIDGING_NPM_VERSION=2.9.14-dev.20260914.ga6894b6a1467.t0328.p4
