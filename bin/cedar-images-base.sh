...
export IMAGE_VERSION=2.9.16-SNAPSHOT
export CEDAR_MAVEN_VERSION=2.9.16-SNAPSHOT
...
export CEDAR_APPLICATION_VERSION=2.9.16-SNAPSHOT
...
export CEDAR_TEMPLATE_EDITOR_NPM_VERSION=2.9.15-dev.20260915.gc32f1d52ab0f.t0135.p4
export CEDAR_WORKSPACE_NPM_VERSION=2.9.15-dev.20260915.g7c6f16b504b1.t0135.p4
export CEDAR_TEMPLATE_DESIGNER_NPM_VERSION=2.9.15-dev.20260913.gf6fd66f88824.t222740.p3
export CEDAR_OPENVIEW_NPM_VERSION=2.9.15-dev.20260915.g1f376ea9bff5.t0135.p4
export CEDAR_OPENVIEW_CEE_NPM_VERSION=2.0.15-dev.20260915.g29b271188cfc.t0135
export CEDAR_OPENVIEW_WEBCOMPONENTS_NPM_VERSION=2.8.0
export CEDAR_CONTENT_NPM_VERSION=2.9.15-dev.20260913.ga3ed6e70c919.t222258.p3
export CEDAR_MONITORING_NPM_VERSION=2.9.15-dev.20260914.g3a1be9eb53c1.t155701.p3
export CEDAR_BRIDGING_NPM_VERSION=2.9.15-dev.20260915.g818553e725bf.t0135.p4
