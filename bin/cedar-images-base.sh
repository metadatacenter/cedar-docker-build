...
export IMAGE_VERSION=2.9.19-SNAPSHOT
export CEDAR_MAVEN_VERSION=2.9.19-SNAPSHOT
...
export CEDAR_APPLICATION_VERSION=2.9.19-SNAPSHOT
...
export CEDAR_TEMPLATE_EDITOR_NPM_VERSION=2.9.18-dev.20260923.gf35e9dfe19ef.t0622.p4
export CEDAR_WORKSPACE_NPM_VERSION=2.9.18-dev.20260923.g6774978ecf5a.t0622.p4
export CEDAR_TEMPLATE_DESIGNER_NPM_VERSION=2.9.18-dev.20260923.g49876bb79315.t0622.p4
export CEDAR_OPENVIEW_NPM_VERSION=2.9.18-dev.20260923.g3bbf90d85582.t0622.p4
export CEDAR_OPENVIEW_CEE_NPM_VERSION=2.0.17-dev.20260923.g0a61530e1e24.t0622
export CEDAR_OPENVIEW_WEBCOMPONENTS_NPM_VERSION=2.8.0
export CEDAR_CONTENT_NPM_VERSION=2.9.18-dev.20260917.g9da1fcbeb40a.t205826.p3
export CEDAR_MONITORING_NPM_VERSION=2.9.18-dev.20260923.g6e4613049a27.t0622.p4
export CEDAR_BRIDGING_NPM_VERSION=2.9.18-dev.20260923.g14d75830a821.t0622.p4
