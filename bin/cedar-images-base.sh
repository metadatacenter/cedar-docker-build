...
export IMAGE_VERSION=2.9.13
export CEDAR_MAVEN_VERSION=2.9.13
...
export CEDAR_APPLICATION_VERSION=2.9.13
...
export CEDAR_TEMPLATE_EDITOR_NPM_VERSION=2.9.13
export CEDAR_WORKSPACE_NPM_VERSION=2.9.13
export CEDAR_TEMPLATE_DESIGNER_NPM_VERSION=2.9.13
export CEDAR_OPENVIEW_NPM_VERSION=2.9.13
export CEDAR_OPENVIEW_CEE_NPM_VERSION=2.0.11
export CEDAR_OPENVIEW_WEBCOMPONENTS_NPM_VERSION=2.8.0
export CEDAR_CONTENT_NPM_VERSION=2.9.13
export CEDAR_MONITORING_NPM_VERSION=2.9.13
export CEDAR_BRIDGING_NPM_VERSION=2.9.13
